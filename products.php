            ...
            <?php
             ...
             if (mysqli_num_rows($catagory_value_fetch_run) > 0) {
               while ($catagory_row = mysqli_fetch_array($catagory_value_fetch_run)) {
                 ...
                 echo "<a class='dropdown-item' href='products.php?cat=$catagory_option_id'>$catagory_option_name</a>";
               }}else {
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href="products.php?edit=<?php echo $product_sl; ?>" style="color:orange;"><i class="fa fa-pencil" aria-hidden="true"></i></a> </td>
              <td><a href="products.php?del=<?php echo $product_sl; ?>" style="color:red"><i class="fa fa-times" aria-hidden="true"></i></a> </td>
            </tr>
          <?php } ?>
